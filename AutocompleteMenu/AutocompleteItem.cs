...
namespace AutocompleteMenuNS
{
    ...
    public class AutocompleteItem
    {
		...
		protected string ReplacePostfix = "";
		...
		public AutocompleteItem(string text, string replacePrefix, string replacePostfix)
		{
			Text = text;
			ReplacePrefix = replacePrefix;
			ReplacePostfix = replacePostfix;
		}
        ...
        {
            return $"{ReplacePrefix}{Text}{ReplacePostfix}";
        }
