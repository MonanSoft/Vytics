...
namespace AutocompleteMenuNS
{
    ...
    public class MethodAutocompleteItem : AutocompleteItem
    {
		...
		public MethodAutocompleteItem(string text, string replacePrefix, string replacePostfix)
			: base(text, replacePrefix, replacePostfix)
		{
			lowercaseText = Text.ToLower();
		}
        ...
        {
			return $"{firstPart}.{ReplacePrefix}{Text}{ReplacePostfix}";
        }
    }
